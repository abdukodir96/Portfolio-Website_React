          ...
          <div className="space-y-8 text-center lg:text-left order-2 lg:order-1">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-xl sm:text-2xl text-muted-foreground max-w-lg">
                  {t("hero.roleBefore")}
                  <span className="text-primary"> {t("hero.roleHighlight")}</span>
                  {t("hero.roleAfter")}
                </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Button
                ...
                asChild
              >
                <a href="#projects">{t("hero.viewMyWork")}</a>
              </Button>
            </div>
            ...
            <div className="grid grid-cols-3 gap-8 pt-8">
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="text-sm text-muted-foreground">{t("hero.statsYears")}</div>
              </div>
              <div className="text-center lg:text-left">
                <div className="text-2xl md:text-3xl mb-1">Seoul</div>
                <div className="text-sm text-muted-foreground">{t("hero.statsLocationCaption")}</div>
              </div>
            </div>
          </div>
              ...
              <div className="relative z-10 group">
                ...
                <div className="absolute -bottom-6 -right-6 bg-background/90 backdrop-blur-sm border border-primary/20 rounded-2xl px-6 py-4 shadow-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm">{t("hero.availableFreelance")}</span>
                  </div>
                </div>
              </div>
            </div>
